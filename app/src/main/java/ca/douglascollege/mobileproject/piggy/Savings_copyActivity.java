...
public class Savings_copyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.addOnMenuItemClickListener(new FabSpeedDial.OnMenuItemClickListener() {
            ...
            public void onMenuItemClick(FloatingActionButton fab, TextView textView, int itemId) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Savings_copyActivity.this);
                final View expenseView = LayoutInflater.from(Savings_copyActivity.this).inflate(R.layout.fragment_savings_dialog, null);
                ...
                builder.setView(expenseView)
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Savings_copyActivity.this, "cancel clicked", Toast.LENGTH_LONG).show();
                            }
                        })
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            Toast.makeText(Savings_copyActivity.this, "ok clicked " + event + " , " + savings, Toast.LENGTH_LONG).show();
                            }
                        });
...
//        });
    ...
    public void deleteItem(int position){
        ...
        Toast.makeText(Savings_copyActivity.this, "position" + position , Toast.LENGTH_LONG).show();
